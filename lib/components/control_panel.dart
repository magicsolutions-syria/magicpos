...
import '../modules/permissions_classes/pay_key_permission.dart';
        ...
        try {
          if (productVal.products.isEmpty()) {
            ...
            if (productVal.ans == "0" || ans == productVal.finalPrice) {
              String printerText = "";
              Map<int, List<Product>> mp =
                  await updateProductUnit(productVal.products);
              ...
              productVal.closeRcPdCh();
              if (productVal.printerOn) {
                PrinterHelperFunctions.print(
                    productVal, context, printerText, mp);
              }
            } else {
              productVal.openRcPdCh();
              showDialog(
              ...
              children: e.map((w) {
                return Expanded(
                  ...
                  child: Consumer<ProductsTableProvider>(
                    builder: (context, productVal, child) => MaterialButton(
