                      ...
                      child: Container(
                        ...
                        child: Consumer<ProductsTableProvider>(
                          builder: (context, value, child) => Text(
                            value.total.toStringAsFixed(value.priceCommas),
                  ...
                  children: [
                    Expanded(
                      ...
                      child: Container(
                        ...
                        child: Consumer<ProductsTableProvider>(
                          builder: (context, value, child) => Text(
                            value.bonus.toStringAsFixed(value.priceCommas),
                            textDirection: TextDirection.rtl,
                            style: TextStyle(
                              fontSize: fontSize,
                              fontWeight: FontWeight.bold,
                  ...
                  children: [
                    Expanded(
                      ...
                      child: Container(
                        ...
                        child: Consumer<ProductsTableProvider>(
                          builder: (context, value, child) => Text(
                            value.discount.toStringAsFixed(value.priceCommas),
                            textDirection: TextDirection.rtl,
                            style: TextStyle(
                              fontSize: fontSize,
                              fontWeight: FontWeight.bold,
                  ...
                  children: [
                    Expanded(
                      ...
                      child: Container(
                        ...
                        child: Consumer<ProductsTableProvider>(
                          builder: (context, value, child) => Text(
                            value.finalPrice.toStringAsFixed(value.priceCommas),
                            textDirection: TextDirection.rtl,
                            style: TextStyle(
                              fontSize: fontSize,
                              fontWeight: FontWeight.bold,
